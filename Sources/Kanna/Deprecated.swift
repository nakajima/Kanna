...
public func XML(xml _: String, url _: String? = nil, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
...
public func XML(xml _: NSData, url _: String? = nil, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
...
public func XML(url _: URL, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
...
public func HTML(html _: String, url _: String? = nil, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
...
public func HTML(html _: NSData, url _: String? = nil, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
...
public func HTML(url _: URL, encoding _: UInt, option _: ParseOption = kDefaultXmlParseOption) -> (any XMLDocument)? {
	nil
}
